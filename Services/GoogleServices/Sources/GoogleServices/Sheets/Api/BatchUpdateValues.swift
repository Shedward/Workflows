...
extension BatchUpdateValues: Modifiers {
    ...
    public func responseDateTimeRenderOption(_ option: DateTimeRenderOption) -> Self { with { $0.responseDateTimeRenderOption = option } }
    public func responseValueRenderOption(_ option: ValueRenderOption) -> Self { with { $0.responseValueRenderOption = option } }
}
